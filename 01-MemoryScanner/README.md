...
1. Abre el programa o juego que quieras analizar.
2. Pulsa Ctrl + Shift + Esc para abrir el Administrador de Tareas.
3. Ve a la pestaña Detalles.
4. Busca el programa en la lista. El nombre que aparece en la columna "Nombre" (incluyendo el .exe) es el que debes poner en el código.
...
---
Desarrollado por Enric-xX // Proyecto de la Suite Cpp-Machines
